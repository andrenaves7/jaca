 ...
 * @internal
 * 
 * Provides internal relationship handling methods for Eloquent-like models.
 * 
 * This trait defines logic for managing model relationships such as:
 * - BelongsTo
 * - HasOne
 * - HasMany
 * - HasAndBelongsToMany
 * 
 * It is intended for use only within the Jaca model infrastructure and should not be used
 * directly outside of the framework's base model classes.
 * 
 * Using this trait in userland code may lead to unexpected behavior and is not supported.
 */
trait InternalDefinesRelations
{
    /**
